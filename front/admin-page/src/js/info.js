...
export const selectedHallType = {chairs: "chairs-hall", prices: "prices-hall"};
...
export function getSeanceHallWidth() {
    return document.getElementsByClassName("conf-step__seances-timeline")[0]?.getBoundingClientRect().width;
}